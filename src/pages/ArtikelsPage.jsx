...
import { deleteArticle, useArticleLibrary } from '../hooks/useOrders'
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-6">
      <h1 className="text-white font-bold text-xl mb-2 flex items-center gap-2">
        <Library size={20} className="text-brand-500" />Artikelbibliotheek
      </h1>
      <p className="text-slate-500 text-sm mb-6">Worden automatisch opgeslagen als je een order aanmaakt met een artikelnummer.</p>
